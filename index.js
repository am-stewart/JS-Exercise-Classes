...
class Car {
  ...
  drive(distance){
    let totalDrivableDistance = this.tank * this.milesPerGallon
    if (distance > totalDrivableDistance) {
      this.odometer += totalDrivableDistance;
      this.tank = 0
...
console.log(brit.grade(alli, 'CSS'));
...
const jessica = new ProjectManager({
  ...
  specialty: 'Web Development',
  favLanguage: 'Python',
  catchPhrase: 'Friday Energy',
  gradClassName: 'Web 49',
  favInstructor: 'Brit'
});
const bob = {
  name: 'Bob',
...
console.log(jessica.grade(bob, 'JavaScript'));
/*
